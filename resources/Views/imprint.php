...
<h1>Impressum</h1>
<p>
    <?= setting('imprintProviderName') ?><br>
    <?= setting('imprintProviderStreet') ?><br>
    <?= setting('imprintProviderPostalCode') ?> <?= setting('imprintProviderCity') ?><br>
    E-Mail: <a href="mailto:<?= setting('imprintProviderEmail') ?>"><?= setting('imprintProviderEmail') ?></a>
</p>
<p>
    <strong>Verantwortlich für den Inhalt (gem. § 55 Abs. 2 RStV):</strong><br>
    <?= setting('imprintResponsibleName') ?><br>
    <?= setting('imprintResponsibleStreet') ?><br>
    <?= setting('imprintResponsiblePostalCode') ?> <?= setting('imprintResponsibleCity') ?><br>
    E-Mail: <a href="mailto:<?= setting('imprintResponsibleEmail') ?>"><?= setting('imprintResponsibleEmail') ?></a>
</p>
<p>
...
<ol>
    ...
    Werbezwecken über ein sog. „Opt-out“ über diese amerikanische Website (<a href="https://optout.aboutads.info">
        https://optout.aboutads.info</a>) oder diese europäische Website (<a href="http://www.youronlinechoices.com/de/praferenzmanagement/">
