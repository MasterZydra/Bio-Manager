...
<form action="?add=1" method="post" class="requiredLegend">
    ...
    <label>
        ...
        <input type="checkbox" name="userIsAdmin" value="1"
            <?php if ($alreadyExist && secPOST('userIsAdmin')) {
                echo ' checked';
            } ?>>
        Administrator
    </label><br>
    <label>
        ...
        <input type="checkbox" name="userIsDeveloper" value="1"
            <?php if ($alreadyExist && secPOST('userIsDeveloper')) {
                echo ' checked';
            } ?>>
        Entwickler
    </label><br>
    <label>
        ...
        <input type="checkbox" name="userIsMaintainer" value="1"
            <?php if ($alreadyExist && secPOST('userIsMaintainer')) {
                echo ' checked';
            } ?>>
        Pfleger
    </label><br>
    <label>
        ...
        <input type="checkbox" name="userIsInspector" value="1"
            <?php if ($alreadyExist && secPOST('userIsInspector')) {
                echo ' checked';
            } ?>>
        Prüfer
    </label><br>
    <label>
        ...
        <input type="checkbox" name="userIsSupplier" value="1"
            <?php if ($alreadyExist && secPOST('userIsSupplier')) {
                echo ' checked';
            } ?>>
        Lieferant
    </label><br>
